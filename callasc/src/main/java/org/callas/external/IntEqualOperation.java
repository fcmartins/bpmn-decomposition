...
import org.callas.absyn.processes.BBool;
 ...
 * 
 */
public class IntEqualOperation implements IExternalOperation {

	private static final FunctionType TYPE = new FunctionType(BOOL_TYPE,
			LONG_TYPE, LONG_TYPE);
	...
	public CallasProcess execute(Sensor sensor,
		...
		return new BBool(left.value == right.value);
	}
