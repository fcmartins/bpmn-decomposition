    ...
    extends Diagram
{
    ...
    @XmlElement(name = "BPMNPlane", namespace = "http://www.omg.org/spec/BPMN/20100524/DI", required = true)
    protected BPMNPlane bpmnPlane;
    @XmlElement(name = "BPMNLabelStyle", namespace = "http://www.omg.org/spec/BPMN/20100524/DI")
